...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="p-4 pb-10 px-10 h-full overflow-hidden min-h-screen rounded-t-2xl relative bg-gradient-to-b from-[#000000] to-[#321469] text-[var(--background-rgb)] flex justify-center w-full"
    >
      <svg
      ...
      >
        <defs>
          <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="30%" stop-color="#8667F2"></stop>
            <stop offset="100%" stop-color="#8C156C"></stop>
          </linearGradient>
        </defs>
        <path
          id="line_about"
          ...
          <div className="flex w-fit flex-none justify-center">
            <div
              className="relative rounded z-[2] cursor-pointer image transition-[filter] duration-500
                      ...
                      after:border-[#8667F2] after:absolute hover:after:top-2 after:duration-500 after:transition-[top,left] hover:after:left-2"
            >
              <Image
                width={0}
                height={0}
